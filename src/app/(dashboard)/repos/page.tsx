...
export default function ReposPage() {
  ...
  const filterAvailableRepos = availableRepos.filter(
    (repo) =>
  ...
  const selectAll = () => {
    setSelectedRepos(new Set(filterAvailableRepos.map((r) => r.githubId)));
  };
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Select Repositories to connect to your app
          </p>
        </div>
        <Button
          onClick={() => {
            ...
            {githubRepos.isLoading ? (
              ...
              <div className="py-16 text-center">
                <div className="mx-auto size-12 rounded-full bg-emerald-500/10 flex items-center justify-center">
                  <CheckCircle className="text-emerald-500 size-6" />
                </div>
              ...
              <>
                <div className="px-6 py-6 border-b border-border/60 flex items-center gap-4">
                ...
                <div className="px-6 py-4 border-t border-border/60 bg-muted/60 flex items-center justify-between">
                  <p className="text-sm text-muted-foreground">
                    {selectedRepos.size} of {filterAvailableRepos.length}{" "}
                    selected
                  </p>
                  <Button
        ...
        <div className="mt-4 pt-4 border-t border-border/60 flex items-center justify-between">
          ...
          <Link href={`/repos/${repo.id}`}>
            <Button
              variant={"ghost"}
              size={"sm"}
              className="h-7 text-sx gap-1.5 mr-2"
            >
              View PRs
